    ...
    <main class="flex-auto flex flex-col justify-center align-center text-center gap-5 bg-white ">
        ...
        <form action="{{ route('menus.store') }}" method="POST">
            ...
            <div class="my-2">
                ...
                @error('nom')
                    <p class="text-red-900 text-lg">Vous devez fournir un nom valide</p>
                @enderror
            </div>
            <div class="my-2">
                ...
                @error('description')
                    <p class="text-red-900 text-lg">Vous devez fournir une description valide</p>
                @enderror
            </div>

            <div class="my-2">
                <label for="prix">Prix</label>
                <input type="number" name="prix" id="prix" class="border-2" old="{{ old('prix') }}">
                @error('prix')
